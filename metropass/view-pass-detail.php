...
<head>
	<title>Metro Commuter Pass Control System || View Pass Page</title>
					...
					if ($query->rowCount() > 0) {
						foreach ($results as $row) {               ?>
							<table border="2" class="table table-bordered" style="font-size: 18px;">
								...
								<tr>
									<th scope>Photo</th>
									<td colspan="3"><img src="admin/images/assets/img/user.jpg" width="50" height="50"></td>
...
<head>
	<title>Metro Commuter Pass Control System || Pass Page</title>
