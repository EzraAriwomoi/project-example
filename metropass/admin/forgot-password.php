...
if (isset($_POST['submit'])) {
    ...
    if ($query->rowCount() > 0) {
        ...
        echo "<script>alert('Invalid phone number or email');</script>";
    }
}
...
<head>
    ...
    <title>Metro Commuter Pass Control System | Forgot Password Page</title>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default" style="background-image:url('../images/casey-horner-p69o_a7XqDM-unsplash.jpg');">
